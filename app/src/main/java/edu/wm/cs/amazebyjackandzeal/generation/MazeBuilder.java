...
public class MazeBuilder implements Runnable {
    ...
    protected int rooms; 		// requested number of rooms in maze, a room is an area with no walls larger than a single cell
    protected int expectedPartiters; 	// user given limit for partiters
