...
import edu.wm.cs.amazebyjackandzeal.maze.MazeFileWriter;
...
public class Seg {
    ...
    public void storeSeg(final Document doc, final Element mazeXML,
        ...
        MazeFileWriter.appendChild(doc, mazeXML, "colSeg_" + number + "_" + i,
                MazePanel.getRGB(this.colorR, this.colorG, this.colorB));
    }
    ...
    public boolean equals(final Object other) {
        ...
        if ((dist != o.dist) || (partition != o.partition) || (seen != o.seen)
                || (MazePanel.getRGB(this.colorR, this.colorG, this.colorB) != MazePanel.getRGB(o.getRed(), o.getGreen(), o.getBlue()))) {
            return false;
        }
    ...
    /**
     * Sets the color of the Seg, using three integers as an RGB representation of the color.
     * @param r the r value of the color to set
     * @param g the g value of the color to set
     * @param b the b value of the color to set
     */
