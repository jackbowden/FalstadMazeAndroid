...
public interface Robot {
    ...
    /**
     * Resets the robot and sets internal state to whatever it should be
     * to begin a new game.
    ...
    /**
     * Returns whether or not the robot has a wall directly adjacent to it in a
     * certain cardinal direction.
     * @author jabowden and tcmzeal
     * @param cardinalDirection the cardinal direction in which the robot will look for a wall
     * @return whether the robot has a wall in the cardinal direction supplied
     */
    boolean hasWallInDirection(CardinalDirection cardinalDirection);

    /**
     * Given that the robot is at the exit, step out of the maze.
     * @return whether the robot was able to exit the maze
     */
    boolean stepOutOfExit();

    /**
     * Set the Cells object associated with this Robot.
     * @param cell
     */
    void setMazeCells(Cells cell);
     ...
     * @author jabowden and tcmzeal
     */
    void turnToDirection(CardinalDirection direction);
}
